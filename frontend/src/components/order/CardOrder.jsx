...
import { updateStatusForUserAPI } from "../../services/order.api";
import { toast } from "react-toastify";
import ModalOrderDetail from "./ModalOrderDetail";
import { timeAgo } from "../../services/format.date";

export default function CardOrder({ getOrder, order }) {
  ...
  const updateStatusOrder = async () => {
    try {
      await updateStatusForUserAPI(order.id);
      getOrder();
