        ...
        <table className=" table-fixed border-collapse border border-red-200">
          <thead>
            <tr className="bg-red-100">
              <th className="border border-red-300 px-4 py-2 w-52 text-nowrap text-center">
                Product Name
              </th>
              <th className="border border-red-300 px-4 py-2 w-52 text-nowrap text-center">
                Price
              ...
              <th className="border border-red-300 px-4 py-2 text-center">
                Quantity
              </th>
              <th className="border border-red-300 px-4 py-2 w-56 text-nowrap text-center">
                Total
              </th>
            </tr>
          </thead>
